...
public interface DevFileService extends IService<DevFile> {
    ...
    public Page<DevFile> file(DevFilePageParam devFilePageParam,String FileSource);
    /**
     * 获取文件详情
     *
     * @author xuyuxiang
    ...
    byte[] getImage(DevFileIdParam devFileIdParam) throws FileNotFoundException, Exception;
    /**
     * 获取文件详情
     *
     * @author xuyuxiang
...
//    String getImgFileToBase64(DevFileIdParam devFileIdParam);
}

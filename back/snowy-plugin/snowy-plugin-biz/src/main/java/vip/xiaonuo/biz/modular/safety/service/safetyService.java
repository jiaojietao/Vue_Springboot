 ...
 */
package vip.xiaonuo.biz.modular.safety.service;
...
public interface safetyService extends IService<safety> {
     ...
     */
     Page<safety> page(safetyPageParam safatyPageParam);
     ...
     */
    void add(safetyAddParam safetyAddParam);
     ...
     */
    void edit(safetyEditParam safetyEditParam);
     ...
     */
    void delete(List<safetyIdParam> safetyIdParamList);
     ...
     * @date 2022/4/24 21:18
     */
    safety detail(safetyIdParam safetyIdParam);
